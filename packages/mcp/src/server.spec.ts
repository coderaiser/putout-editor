...
test('server: docs tool has a string description', (t) => {
    const server = createServer();
    const result = typeof server._registeredTools.docs.description;
...
test('server: parse tool has a string description', (t) => {
    const server = createServer();
    const result = typeof server._registeredTools.parse.description;
    const expected = 'string';
...
test('server: find_places tool has a string description', (t) => {
    const server = createServer();
    const result = typeof server._registeredTools.find_places.description;
    const expected = 'string';
...
test('server: transform tool has a string description', (t) => {
    const server = createServer();
    const result = typeof server._registeredTools.transform.description;
    const expected = 'string';
